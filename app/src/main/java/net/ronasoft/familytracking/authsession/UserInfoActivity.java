...
package net.ronasoft.familytracking.authsession;
...
import net.ronasoft.familytracking.ItemListActivity;
...
public class UserInfoActivity extends AppCompatActivity {
    ...
    private void signOut() {
        ...
        Intent completionIntent = new Intent(this, ItemListActivity.class);
